...
execute as @a[scores={rl_teams=1}] run function rl:ui/chat/triggers/teams

#FIXME: custom function maybe?
execute as @a[scores={rl_teams_none=1}] run team join rl_team_none @s
execute as @a[scores={rl_teams_none=1}] run function rl:ui/chat/triggers/teams
execute as @a[scores={rl_teams_red=1}] run team join rl_team_red @s
execute as @a[scores={rl_teams_red=1}] run function rl:ui/chat/triggers/teams
execute as @a[scores={rl_teams_green=1}] run team join rl_team_green @s
execute as @a[scores={rl_teams_green=1}] run function rl:ui/chat/triggers/teams
execute as @a[scores={rl_teams_gold=1}] run team join rl_team_gold @s
execute as @a[scores={rl_teams_gold=1}] run function rl:ui/chat/triggers/teams
execute as @a[scores={rl_teams_aqua=1}] run team join rl_team_aqua @s
execute as @a[scores={rl_teams_aqua=1}] run function rl:ui/chat/triggers/teams
