...
execute as @s on target if entity @s[predicate=rl:locks/lockpick_level2, predicate=rl:random/0_25] run function rl:logic/opening/doors/lockpicks/lockpick_success
