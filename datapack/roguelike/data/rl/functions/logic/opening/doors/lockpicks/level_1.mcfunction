...
execute as @s on target if entity @s[predicate=rl:locks/lockpick_level1] if predicate rl:random/0_10 run function rl:logic/opening/doors/lockpicks/lockpick_success
