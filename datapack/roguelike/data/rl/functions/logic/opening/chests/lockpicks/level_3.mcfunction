...
execute as @s on target if entity @s[predicate=rl:locks/lockpick_level3, predicate=rl:random/0_50] run function rl:logic/opening/chests/lockpicks/lockpick_success
