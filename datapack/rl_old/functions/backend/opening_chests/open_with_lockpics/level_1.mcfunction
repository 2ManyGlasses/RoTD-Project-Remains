...
execute as @s on target if entity @s[nbt={SelectedItem:{tag:{lockpickLevel:1b}}}, predicate=rl:lockpicks/level1] run function rl:backend/opening_chests/open_with_lockpics/lockpick_success
