...
execute as @s on target if entity @s[predicate=rl:rods/thief] if predicate rl:random/0_15 run function rl:backend/opening_doors/open_with_lockpics/lockpick_success
#FIXME: spell sound
