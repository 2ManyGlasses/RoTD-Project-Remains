...
execute as @s on target if entity @s[nbt={SelectedItem:{tag:{lockpickLevel:3b}}}, predicate=rl:lockpicks/level3] run function rl:backend/opening_doors/open_with_lockpics/lockpick_success
