...
execute as @s on target if entity @s[nbt={SelectedItem:{tag:{lockpickLevel:2b}}}, predicate=rl:lockpicks/level2] run function rl:backend/opening_doors/open_with_lockpics/lockpick_success
